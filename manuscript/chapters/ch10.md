...
prerequisites:
  - kernels-for-text
objectives:
  - Explain the central definitions and claims in Kernels for and on Graphs.
...
<figcaption>Each press of step runs one exact round of 1-WL color refinement, with the color dictionary shared across both graphs; the histograms beneath are precisely what the WL subtree kernel compares. The pendant pair separates at round 2 and the path against the star at round 1, while the 6-cycle against two triangles never separates: both are 2-regular, the blind spot the text proves.</figcaption>
</figure>
...
This chapter established explain the central definitions and claims in Kernels for and on Graphs; Apply the chapter's principal methods and interpret their outputs; State the assumptions behind formal results and connect them to earlier chapters. Revisit the assumptions attached to each formal result before transferring it to a new setting. For primary and extended treatments, consult [@gartner2003], [@kashima2003], [@borgwardt2005].
