...
<figure class="viz" data-widget="wl-refine">

<figcaption>Each panel records one exact round of 1-WL color refinement, using a color dictionary shared across both graphs; the histograms are precisely what the WL subtree kernel compares. A pendant pair separates at round 2 and a path from a star at round 1, while a 6-cycle and two triangles never separate because both are 2-regular. The web version steps through these cases.</figcaption>
</figure>
