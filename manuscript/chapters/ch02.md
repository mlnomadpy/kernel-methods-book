...
<figcaption>Centering, distances, and projections can all be expressed through this matrix alone. The kernel trick is valid precisely because these operations ask only for inner products, not for coordinates of \(\Phi(x)\).</figcaption>
</figure>
