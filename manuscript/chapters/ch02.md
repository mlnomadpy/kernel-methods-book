...
objectives:
  - >-
    Explain the central definitions and claims in The Kernel Trick and the
    Representer Theorem.
...
This chapter established explain the central definitions and claims in The Kernel Trick and the Representer Theorem; Apply the chapter's principal methods and interpret their outputs; State the assumptions behind formal results and connect them to earlier chapters. Revisit the assumptions attached to each formal result before transferring it to a new setting. For primary and extended treatments, consult [@vapnik1995], [@scholkopf2002], [@aronszajn1950].
